...
def futureSimulation(city, state):
    ...
    blankmap.resize((800,488), Image.ANTIALIAS)

    blankmappixels = blankmap.load()

    temp_color_to_fire_risk_index= {"dark_red": 8, "red" : 7 , "orange": 6, "yellow": 5, "blue": 4, "green": 3, "purple": 2, "pink": 1, "water": 0}
    
    color_to_temp = {"dark_red": 72.5, "red" : 67.5 , "orange": 62.5, "yellow": 57.5, "blue": 52.5, "green": 47.5, "purple": 42.5, "pink": 37.5, "water": 0}
    
    humidity_to_fire_risk_index = {"blue": 1, "dark_green": 2, "green" : 3, "yellow_green" : 4, "light_green" : 5, "yellow" : 6, "orange" : 7, "red" : 8, "water": 0}
    ...
    for x in range(int(img_x) - 480,int(img_x) + 480):
            
        for y in range(int(img_y) - 480, int(img_y) + 480):
            ...
            try:
                ...
                if (fire_risk_index == 0):
                    blankmappixels[x,y] = (255, 255, 255)
